...
import 'package:contact_app_hive/features/contact/presentation/screens/home/widgets/contact_item.dart';
import 'package:contact_app_hive/features/contact/presentation/widgets/custom_toast.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    _homeBloc = HomeBloc(SharedPreferencesHelper(), HiveHelper(), context);
    _homeBloc.add(LoadContacts());
  }

  void _showDeleteDialog(ContactData contactId) {
    showDialog(
      context: context,
              ...
              return state.contacts.isEmpty
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (context, index) => ContactItem(
                        ...
                        onItemClick: () async {
                          CustomToast.show(state.contacts[index].id.toString());
